...
$(if $(findstring mingw32,$(1)),-DCMAKE_SYSTEM_NAME=Windows -DCMAKE_C_COMPILER=x86_64-w64-mingw32-gcc -DCMAKE_CXX_COMPILER=x86_64-w64-mingw32-g++ -DLLVM_ENABLE_PIC=OFF -DLLVM_ENABLE_THREADS=OFF -DCMAKE_CXX_FLAGS="-fpermissive -Wno-error",\
